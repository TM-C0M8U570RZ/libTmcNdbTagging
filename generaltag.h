...
class TMCNDBTAGGING_EXPORT GeneralTag : public tmc::Bidoof::NdbTag
{
public:
    GeneralTag(AxceModYum am, std::string tag, std::vector<std::shared_ptr<NdbTag>> parents = {}, std::vector<std::string> aliases = {});
