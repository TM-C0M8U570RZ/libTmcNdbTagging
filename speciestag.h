...
class TMCNDBTAGGING_EXPORT SpeciesTag : public NdbTag
{
public:
    SpeciesTag(AxceModYum am, std::string tag, std::vector<std::shared_ptr<NdbTag>> parents = {}, std::vector<std::string> aliases = {});
