...
class TMCNDBTAGGING_EXPORT ReservedNdbTag : public tmc::Bidoof::NdbTag
{
public:
    ReservedNdbTag(AxceModYum am, std::string tag, std::vector<std::shared_ptr<NdbTag>> parents = {}, std::vector<std::string> aliases = {});
