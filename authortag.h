...
class TMCNDBTAGGING_EXPORT AuthorTag : public tmc::Bidoof::NdbTag
{
public:
    AuthorTag(AxceModYum am, std::string tag, std::vector<std::shared_ptr<NdbTag>> parents = {}, std::vector<std::string> aliases = {});
