...
class TMCNDBTAGGING_EXPORT LoreTag : public tmc::Bidoof::NdbTag
{
public:
    LoreTag(AxceModYum am, std::string tag, std::vector<std::shared_ptr<NdbTag>> parents = {}, std::vector<std::string> aliases = {});
