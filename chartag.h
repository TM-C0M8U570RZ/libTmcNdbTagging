...
class TMCNDBTAGGING_EXPORT CharTag : public tmc::Bidoof::NdbTag
{
public:
    CharTag(AxceModYum am, std::string tag, std::vector<std::shared_ptr<NdbTag>> parents = {}, std::vector<std::string> aliases = {});
